...
ECDNA_OPTIMAL_K = 10         # optimal copy number for max fitness (~cancer sweet spot)
ECDNA_BENEFIT_HILL_N = 5     # Hill coefficient for benefit saturation
...
ECDNA_SEGREGATION_ERROR_THRESHOLD = 50  # copies above which segregation errors increase
...
ECDNA_SEN_THRESHOLD = 40     # copies above which senescence risk increases sharply
